...
;-| Special Motions |------------------------------------------------------
[Command]
name = "Silver Lance Up 1"
command = ~F, D, DF, a
time = 15

[Command]
name = "Silver Lance Up 2"
command = ~F, D, DF, b
time = 15

[Command]
name = "Silver Lance Up Air"
command = ~F, D, DF, a
time = 15
...
[Command]
name = "Silver Bow Crouch 1"
command = ~D, DB, B, x
time = 15

[Command]
name = "Silver Bow Crouch 2"
command = ~D, DB, B, y
time = 15
...
;---------------------------------------------------------------------------
[State -1, AI Critical Hit]
type = ChangeState
triggerall = var(59) = 1
triggerall = RoundState = 2
triggerall = AILevel >= 7
triggerall = Power >= 3000
triggerall = (StateType = S || StateType = C) && (!MoveGuarded)
trigger1 = ((p2MoveType = H) && (P2StateNo != [5080,5150])) || (P2MoveType = A)
trigger1 = p2BodyDist X <= 200 && P2BodyDist Y <= 50
trigger1 = ctrl = 1
value = 3000

[State -1, AI Silver Lance Up Heavy]
type = ChangeState
triggerall = var(59) > 0
triggerall = RoundState = 2
...
;===========================================================================
;Critical Hit
[State -1, Critical Hit]
type = ChangeState
value = 3000
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Critical Hit"
triggerall = power >= 3000
...
;---------------------------------------------------------------------------
;Silver Bow Hyper
[State -1, Silver Bow Hyper]
type = ChangeState
value = 3100
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Bow Hyper"
...
trigger3 = stateno = [400,450]
trigger3 = (time >= 9) || MoveContAct
trigger4 = stateno = [1100, 1102]
trigger4 = MoveContact
trigger5 = (stateno = 1300) || (stateno = 1310)
trigger5 = MoveContact

;===========================================================================
;---------------------------------------------------------------------------
; Silver Lance Up 01
[State -1, Silver Lance Up 01]
type = ChangeState
value = 1000
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Lance Up 1"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 9) || MoveContAct
trigger3 = stateno = [400,450]
...
;---------------------------------------------------------------------------
; Silver Lance Up 02
[State -1, Silver Lance Up 02]
type = ChangeState
value = 1010
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Lance Up 2"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 9) || MoveContAct
trigger3 = stateno = [400,450]
...
;---------------------------------------------------------------------------
; Silver Lance Up Heavy
[State -1, Silver Lance Up Heavy]
type = ChangeState
value = 3020
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Lance Up 3"
triggerall = power >= 1000
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 9) || MoveContAct
...
trigger4 = (time >= 28) || MoveContAct
trigger5 = stateno = 1310
trigger5 = (time >= 40) || MoveContAct

;---------------------------------------------------------------------------
; Silver Bow Air
[State -1, Silver Bow Air]
type = ChangeState
value = 1050
triggerall = Var(59) = 0
triggerall = command = "Silver Lance Up Air"
trigger1 = (statetype = A) && ctrl
trigger2 = stateno = [600,650]
trigger2 = (time >= 15) || MoveContAct

;---------------------------------------------------------------------------
; Silver Bow 01
[State -1, Silver Bow 01]
type = ChangeState
value = 1300
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Bow 1"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 15) || MoveContAct
trigger3 = stateno = [400,450]
trigger3 = (time >= 15) || MoveContAct

;---------------------------------------------------------------------------
; Silver Bow 02
[State -1, Silver Bow 02]
type = ChangeState
value = 1310
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Bow 2"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 15) || MoveContAct
trigger3 = stateno = [400,450]
...
;---------------------------------------------------------------------------
; Silver Bow Crouch 01
[State -1, Silver Bow Crouch 01]
type = ChangeState
value = 1320
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Bow Crouch 1"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 15) || MoveContAct
trigger3 = stateno = [400,450]
...
;---------------------------------------------------------------------------
; Silver Bow Crouch 02
[State -1, Silver Bow Crouch 02]
type = ChangeState
value = 1330
triggerall = Var(59) = 0
triggerall = statetype != A
triggerall = command = "Silver Bow Crouch 2"
trigger1 = (statetype = S) && ctrl
trigger2 = stateno = [200,250]
trigger2 = (time >= 15) || MoveContAct
trigger3 = stateno = [400,450]
