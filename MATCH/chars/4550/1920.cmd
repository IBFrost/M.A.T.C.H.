...
trigger5 = (stateno = 280) && movecontact | MoveReversed 
trigger6 = (stateno = 230) && movecontact | MoveReversed 
trigger7 = (stateno = 200) && movecontact | MoveReversed 
trigger8 = (stateno = 201) && movecontact | MoveReversed 
ignorehitpause = 1
...
trigger3 = (stateno = 2003) && movecontact | MoveReversed 
trigger4 = (stateno = 204) && movecontact | MoveReversed 
...
trigger3 = stateno = 211 && MoveReversed 
...
[State 7040,VelSet]
type = VelSet
trigger1 = Anim = [251,257]
trigger1 = MoveHit = 1
triggerall = var(51) >= 3
trigger1 = random = [101,999] 
trigger1 = vel X > 1
trigger1 = vel X = 0
triggerall      = var(59) = 1
...
triggerall = p2bodydist X > 0
trigger1 = ctrl
trigger1 = random = [989,999]
trigger2 = StateNo = 103
trigger2 = random = [989,999]
trigger3 = StateNo = 101
trigger3 = random = [989,999]
ignorehitpause = 1
...
triggerall = statetype != A
trigger1 = ctrl && EnemyNear,HitDefAttr = SCA, AA, AP, HT, NT, ST, NA, SA, HA, NT, SP, NP, HP, AT
trigger1 = random < 15
trigger2 = stateno = 103
trigger2 = ctrl && EnemyNear,HitDefAttr = SCA, AA, AP, HT, NT, ST, NA, SA, HA, NT, SP, NP, HP, AT
trigger2 = random < 15
ignorehitpause = 0
